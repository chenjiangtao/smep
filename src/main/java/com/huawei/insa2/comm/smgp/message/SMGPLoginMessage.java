...
public class SMGPLoginMessage extends SMGPMessage
{
    ...
    public SMGPLoginMessage(String clientId, String shared_Secret, int loginMode, Date timestamp, int version) throws IllegalArgumentException
    {
        if(clientId == null)
        ...
        //TypeConvert.int2byte(0x7b4da8, super.buf, 37);
        TypeConvert.int2byte(Integer.valueOf(tmptime), super.buf, 37);
