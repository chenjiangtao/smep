...
public class MM7ReceiveServlet extends HttpServlet implements MM7AbstractReceiver {
	...
	private byte[] encodeMessage(MM7VASPRes mm7VASPRes) {
		...
		if (mm7VASPRes.isTransactionIDExist()) //
			sb.append("<mm7:TransactionID xmlns:mm7=\"http://www.3gpp.org/ftp/Specs/archive/23_series/23.140/schema/REL-6-MM7-1-0\">"
	...
	private boolean basicAuth(HttpServletResponse rsp,
	...
	private boolean digestAuth(HttpServletResponse rsp,
