...
public class MM7Config {
	...
	public void load(String configFileName) {
		...
		MMSCIP = (List<String>) hashmap.get("mmscIP");
	...
	*/
	...
	public void setMMSCIP(List<String> ip) // 设置MMSC的IP列表
	{
		MMSCIP = ip;
	}

	public List<String> getMMSCIP() // 获得MMSC的IP列表
	{
		return (MMSCIP);
	}
	...
	public void setConnConfig(String KeepAlive, int MaxKeepAliveRequests, int ServerMaxKeepAlive, int MinKeepAliveRequests, int KeepAliveTimeout, int step) {
		ConnConfig = String.format("<connection><KeepAlive>%s</KeepAlive><MaxKeepAliveRequests>%d</MaxKeepAliveRequests><ServerMaxKeepAlive>%d</ServerMaxKeepAlive><MinKeepAliveRequests>%d</MinKeepAliveRequests><KeepAliveTimeout>%d</KeepAliveTimeout><step>%d</step></connection>", 
				KeepAlive, MaxKeepAliveRequests, ServerMaxKeepAlive, MinKeepAliveRequests, KeepAliveTimeout, step);
	}
