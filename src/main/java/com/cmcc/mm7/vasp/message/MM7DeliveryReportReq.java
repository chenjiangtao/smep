...
public class MM7DeliveryReportReq extends MM7RSReq {
	...
	public MM7DeliveryReportReq() {
		super.mmsReportLog = new MmsReportLog();
	}
	...
	public void setMMSRelayServerID(String mmscID) // 设置MMSRelay/ServerRelay/Server的标识符
	{
		...
		super.mmsReportLog.setMmsrelayserverid(MMSRelayServerID);
	}
	...
	public void setMessageID(String messageID) // 设置messageID
	{
		MessageID = messageID;
		MessageIDExist = true;
		super.mmsReportLog.setMessageid(MessageID);
	}
	...
	public void setRecipient(String address) // 设置递送报告所通报的状态对应的接收方地址
	{
		...
		super.mmsReportLog.setDestTerminalId(RecipientAddress);
	}
	...
	public void setSender(String senderAddress) // 设置MM始发方的地址
	{
		...
		super.mmsReportLog.setSrcTerminalId(SenderAddress);
	}
	...
	public void setTimeStamp(Date timeStamp) // 设置提交MM的时间和日期（绝对时间）
	{
		TimeStamp = timeStamp;
		TimeStampExist = true;
		super.mmsReportLog.setMmtimestamp(TimeStamp);
	}
	...
	public void setMMStatus(byte mmStatus) // 设置MmStatus
	{
		MMStatus = mmStatus;
		MMStatusExist = true;
		super.mmsReportLog.setMmstatus((int)MMStatus);
	}
	...
	public void setStatusText(String mmStatusText) // 设置MMStatusText
	{
		...
		super.mmsReportLog.setStatustext(MMStatusText);
	}
