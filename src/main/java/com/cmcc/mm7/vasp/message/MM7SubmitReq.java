...
public class MM7SubmitReq extends MM7VASPReq {
	 ...
	 * String getFeeTerminalID() //获得feeTerminalID { return(this.FeeTerminalID);
	 * } public boolean isFeeTerminalIDExist() //是否存在feeTerminalID {
	 * //在付费方既不是发送方，也不是接收方的情况下， return(FeeTerminalIDExist);
	 * //需要使用该字段标识付费方的E.164号码 }
	 */
