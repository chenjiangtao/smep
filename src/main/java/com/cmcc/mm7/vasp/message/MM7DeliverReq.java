...
public class MM7DeliverReq extends MM7RSReq {
	...
	public MM7DeliverReq() {
		super.mmsMoLog = new MmsMoLog();
	}
	...
	public void setMMSRelayServerID(String mmscID) // 设置MMSC的标识符
	{
		...
		super.mmsMoLog.setMmsrelayserverid(MMSRelayServerID);
	}
	...
	public void setLinkedID(String linkedID) // 设置linkedID
	{
		LinkedID = linkedID;
		LinkedIDExist = true;
		super.mmsMoLog.setLinkid(LinkedID);
	}
	...
	public void setSender(String senderAddress) // 设置MM始发方的地址
	{
		...
		super.mmsMoLog.setSrcTerminalId(SenderAddress);
	}
	...
	public void setTo(List<String> addressList) // 批量设置接收方MM的地址
	{
		To = addressList;
		ToExist = true;
		super.mmsMoLog.setDestTerminalId(To.toString().replaceAll("\\[|\\]", ""));
	}
	/*	
	...
	*/
	public List<String> getTo() // 获得接收方MM的地址
	{
		return (To);
	}
	...
	public void setCc(List<String> ccAddressList) // 设置抄送方MM的地址
	{
		Cc = ccAddressList;
		CcExist = true;
		super.mmsMoLog.setDestcc(Cc.toString().replaceAll("\\[|\\]", ""));
	}
	/*
	...
	*/
	public List<String> getCc() // 获得抄送方MM的地址
	{
		return (Cc);
	}
	...
	public void setBcc(List<String> bccAddressList) // 设置密送方MM的地址
	{
		Bcc = bccAddressList;
		BccExist = true;
		super.mmsMoLog.setDestcc(Bcc.toString().replaceAll("\\[|\\]", ""));
	}
	/*
	...
	*/
	public List<String> getBcc() // 获得密送方MM的地址
	{
		return (Bcc);
	}
	...
	public void setTimeStamp(Date timeStamp) // 设置提交MM的时间和日期
	{
		TimeStamp = timeStamp;
		TimeStampExist = true;
		super.mmsMoLog.setMmtimestamp(TimeStamp);
	}
	...
	public void setReplyChargingID(String replyChargingID) // 设置ReplyChargingID
	{
		...
		super.mmsMoLog.setReplychargingid(ReplyChargingID);
	}
	...
	public void setPriority(byte priority) // 设置Priority
	{
		Priority = priority;
		PriorityExist = true;
		super.mmsMoLog.setPriority((int)Priority);
	}
	...
	public void setSubject(String subject) // 设置subject
	{
		Subject = subject;
		SubjectExist = true;
		super.mmsMoLog.setMmssubject(Subject);
	}
